...
do
    python gridness_scores.py param_sweep_with_place_margin_0_bc_$1 --neuron_idx=$n
    #python gridness_scores.py param_sweep_without_place_margin_0_bc_$1 --neuron_idx=$n
done
