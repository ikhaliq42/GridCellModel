...
def create_mesh(top_left_corner, bottom_right_corner, x_spacing, y_spacing):
    ...
    # vertical lines
    vert_x_starts = np.arange(x_min,x_max + x_spacing, x_spacing)
    ...
    vert_ends     = zip(vert_x_starts, vert_y_starts)
    vert_lines    = zip(vert_starts, vert_ends)

    # horizontal lines
    horiz_y_starts = np.arange(y_min,y_max + y_spacing, y_spacing)
    ...
    horiz_ends     = zip(horiz_x_starts, horiz_y_starts)
    horiz_lines    = zip(horiz_starts, horiz_ends)

    # return lines
    return vert_lines.extend(horiz_lines)
