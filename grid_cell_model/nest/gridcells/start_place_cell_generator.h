...
#ifndef START_PLACE_CELL_GENERATOR_H
#define START_PLACE_CELL_GENERATOR_H
...
/**
 * Start Place cell generator model.
 *
 ...
 *
 */
class start_place_cell_generator : public nest::Node
{
    public:
        ...
        start_place_cell_generator(start_place_cell_generator const&);
...
inline
nest::port start_place_cell_generator::check_connection(nest::Connection& c, nest::port receptor_type)
{
    nest::SpikeEvent e;
    e.set_sender(*this);
    c.check_event(e);
...
inline
void start_place_cell_generator::get_status(DictionaryDatum &d) const
{
    P_.get(d);
...
inline
void start_place_cell_generator::set_status(const DictionaryDatum &d)
{
...
#endif //START_PLACE_CELL_GENERATOR_H
