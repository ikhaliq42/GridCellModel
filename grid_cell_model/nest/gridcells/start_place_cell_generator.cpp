/*
 *  start_place_cell_generator.cpp
 *
...
vecType start_place_cell_generator::Parameters_::rat_pos_x(1, .0);
vecType start_place_cell_generator::Parameters_::rat_pos_y(1, .0);
double start_place_cell_generator::Parameters_::rat_pos_dt = 20.; // msec
...
start_place_cell_generator::Parameters_::Parameters_()
    : rate(      0.0),  // pA
      ctr_x(      .0),  // cm
      ctr_y(      .0),  // cm
      field_size(10.)   // cm 
...
void start_place_cell_generator::Parameters_::get(DictionaryDatum &d) const
{
...
void start_place_cell_generator::Parameters_::set(const DictionaryDatum& d)
{
...
start_place_cell_generator::start_place_cell_generator()
    : Node(), device_(), P_()
{
    sim_dt_per_pos_dt = 0;
    next_pos_step = 0;
...
start_place_cell_generator::start_place_cell_generator(const start_place_cell_generator& n)
...
void start_place_cell_generator::init_state_(const Node& proto)
{
    const start_place_cell_generator& pr = downcast<start_place_cell_generator>(proto);

    device_.init_state(pr.device_);
}


void start_place_cell_generator::init_buffers_()
{
    device_.init_buffers();
}


void start_place_cell_generator::calibrate()
{
    device_.calibrate();
...
void start_place_cell_generator::update(Time const & T, const long_t from, const long_t to)
{
...
inline
double start_place_cell_generator::gaussianFunction()
{
...
inline
void start_place_cell_generator::setFiringRate()
{
